...
<head>
    ...
    <title>Form Nilai MahaSiswa STT Nurul Fikri</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css"> 
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
</head>
<body>
<div>
<h2> Form Nilai MahaSiswa STT Nurul Fikri </h2>
</div>
<hr>
<br>

<form method="POST" action="Tugas_Praktikum2.php" style = "margin-left : 30%;">
  ...
  <div class="form-group row">
    <label for="select" class="col-2 col-form-label">Mata Kuliah Di STT Nurul Fikri</label> 
    <div class="col-7">
      <select id="select" name="matkul" class="custom-select" style="width: 50%">
        <option value="DDP">Dasar-Dasar Pemograman</option>
        <option value="BD1">Basis Data</option>
        <option value="Stka">Statiska</option>
